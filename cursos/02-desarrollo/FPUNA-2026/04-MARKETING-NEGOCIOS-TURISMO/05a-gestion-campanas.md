...
graph TD
    ...
    C --> D[Estrategia Multicanal]
    D --> E[Asignar Presupuesto]
    E --> F[Crear Assets]
    F --> G[Lanzar Campaña]
    G --> H[Monitoreo Diario]
    H --> I{¿Cumple Metas?}
    I -->|No| J[Optimizar]
    J --> H
    I -->|Sí| K[Escalar Inversión]
    K --> H
    H --> L[Finalizar Campaña]
    L --> M[Reporte Final]
    M --> N[Learnings para Próxima]
...
graph TD
    ...
    subgraph "Earned Media"
        C1[PR/Prensa]
        C2[Influencers]
        C3[Reviews/Testimonios]
        C4[Word of Mouth]
    end
    
    A1 --> D[Campaña Integrada]
    A2 --> D
    B1 --> D
    B2 --> D
    C2 --> D
