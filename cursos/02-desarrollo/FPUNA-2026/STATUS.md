...
|--------|---------|--------|
| 01 | `01-configuracion-stack-ia.md` | ✅ |
| 02 | `02-maestria-configuracion.md` | ✅ |
| 03 | `03-ingenieria-prompts.md` | ✅ |
| 04 | `04-ingenieria-contexto.md` | ✅ |
| 05 | `05-proyecto-en-vivo.md` | ✅ |
| 06 | `06-patrones-flujo-trabajo.md` | ✅ |

**Recursos adicionales**:
- `live-demo-proyecto/` - Proyecto ejemplo completo ✅
- `_components/_prerequisites.md` - Requisitos técnicos ✅
...
**Duración**: 20 horas + especializaciones opcionales
**Contenido**: Arquitectura, patrones, testing, código limpio
...
**Duración**: 20 horas clase + 15-60 horas proyecto
**Contenido**: Circuitos, PCB, firmware, IoT, automatización

| Módulo | Archivo | Estado |
|--------|---------|--------|
| 01 | `01-diseno-circuitos-ia.md` | ✅ |
| 02 | `02-diseno-pcb.md` | ✅ |
| 03 | `03-desarrollo-firmware.md` | ✅ |
...
|------------|-----------|--------|
| `instalacion-opencode/` | Guías Windows/Mac/Linux + FAQ | ✅ |
| `configuracion-mcp/` | Setup de MCPs | ✅ |
...
| Día | Track | Ejercicios resueltos | Estado |
|-----|-------|---------------------|--------|
| dia-01 | Fundamentos | 3 | ✅ |
| dia-02 | Electrónica | 2 | ✅ |
| dia-03 | Aeronáutica | 1 | ✅ |
| dia-04 | Software | 1 | ✅ |
| dia-05 | Marketing | 1 | ✅ |
| dia-06 | Investigación | 1 | ✅ |

**Total ejercicios resueltos**: 9
...
- [ ] Activar GitHub Actions para verificación de links
...
*Este archivo provee detalle a nivel de track. Para estado general del repositorio, ver `/STATUS.md`*
