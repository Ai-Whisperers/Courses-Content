...
Estos tutoriales profundizan en cada tema del módulo:

- 📖 [01_Network_Interception.md](./tutorials/01_Network_Interception.md) - Mockear APIs y requests
- 📖 [02_Visual_Regression.md](./tutorials/02_Visual_Regression.md) - Testing visual de cambios
- 📖 [03_Complex_Components.md](./tutorials/03_Complex_Components.md) - Modals, iFrames, Shadow DOM
- 📖 [04_Authentication.md](./tutorials/04_Authentication.md) - Manejo de login y sesiones
- 📖 [05_Performance.md](./tutorials/05_Performance.md) - Optimizar velocidad de tests

---

## Ejemplos de IA (Copy-Paste Ready)

Prompts listos para usar con OpenCode para generar test code:

- 🤖 [01_NetworkMocking_Prompt.md](./examples/01_NetworkMocking_Prompt.md) - Generar tests con network mocking
- 🤖 [02_VisualRegression_Prompt.md](./examples/02_VisualRegression_Prompt.md) - Generar visual regression tests
- 🤖 [03_AuthenticationSetup_Prompt.md](./examples/03_AuthenticationSetup_Prompt.md) - Setup de autenticación
...
**Continúa con**: [Módulo 02 - API Testing](../02-pruebas-api/README.md)
