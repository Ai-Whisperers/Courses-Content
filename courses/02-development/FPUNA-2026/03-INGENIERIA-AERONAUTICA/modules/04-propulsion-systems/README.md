...
En Sistemas de Propulsión, OpenCode es un **asistente técnico poderoso**, pero **NO un ingeniero aeronáutico**. Entender esta distinción es crítico para tu éxito profesional.
...
**Ejemplos en Sistemas de Propulsión**:
- Calcular autonomía para 100 combinaciones motor/batería
- Generar curvas de performance (empuje vs velocidad)
- Documentar selección de motor con justificación técnica
...
**Ejemplos en Sistemas de Propulsión**:
- Encontrar relación T/W óptima entre 0.3-0.7
- Ajustar diámetro de hélice para maximizar eficiencia
- Distribuir baterías para optimizar balance CG
...
**Ejemplos en Sistemas de Propulsión**:
- Generar reporte técnico de selección de motor
- Crear tabla comparativa de 10 configuraciones de propulsión
...
**Ejemplos en Sistemas de Propulsión**:
- Detectar inconsistencias en parámetros de motor
- Identificar valores de eficiencia fuera de rango normal
- Alertar sobre configuraciones de batería sospechosas
...
**Ejemplos en Sistemas de Propulsión**:
- ❌ Diseñar sistema de propulsión híbrido innovador
  - **Por qué falla**: Requiere intuición sobre integración de sistemas complejos
  - **Tu rol**: Entender termodinámica, mecánica, y control de sistemas
  
- ❌ Inventar nueva configuración de motor sin precedentes
...
- ❌ Optimizar para criterios contradictorios no cuantificables
  - **Por qué falla**: No puede balancear "ruido vs performance" sin definición clara
...
**Ejemplos en Sistemas de Propulsión**:
- ❌ Decidir si motor es 'suficientemente seguro' para misión
...
- ❌ Validar que sistema de propulsión cumple normas de aeronavegabilidad
  - **Por qué falla**: Regulaciones requieren interpretación legal + técnica
  - **Tu rol**: Responsabilidad legal del ingeniero firmante

- ❌ Decidir si margen de seguridad de batería es 'suficiente'
...
**Ejemplos en Sistemas de Propulsión**:
- ❌ Seleccionar motor considerando disponibilidad en Paraguay
  - **Por qué falla**: No conoce mercado local, importadores, tiempos de entrega
  - **Tu rol**: Conocimiento del ecosistema de proveedores paraguayos

- ❌ Diseñar considerando servicio técnico disponible localmente
  - **Por qué falla**: No sabe qué talleres pueden reparar qué tipos de motores
  - **Tu rol**: Network de talleres aeronáuticos en Paraguay
...
- ❌ ¿Maximizar performance vs minimizar costo de operación?
...
- ❌ ¿Usar motor certificado vs motor experimental?
...
1. **Números sospechosos**:
   ...
   - Autonomía de 10 horas con batería 1000mAh (físicamente imposible)
   - Thrust-to-weight ratio >10 para motor eléctrico (irreal)

2. **Contradicciones internas**:
   - "Alta potencia pero bajo consumo" (sin justificar cómo)
   - "Larga autonomía y alta velocidad" (sin especificar trade-off)

3. **Ignorancia de restricciones**:
   - Motor que no existe en el mercado
   - Batería con densidad energética imposible
   - Combinaciones motor/hélice incompatibles

4. **Falta de incertidumbre**:
   - IA da respuestas con 100% confianza en problemas complejos
   - No menciona supuestos o limitaciones del cálculo
...
```
Ejemplo en Sistemas de Propulsión:
- IA calcula autonomía de UAV
- TÚ verificas:
  ✓ ¿Autonomía es razonable? (10-60 min típico para UAVs pequeños)
  ✓ ¿Consumo de batería es realista? (20-40A típico para UAV 3kg)
  ✓ ¿Eficiencia del motor es alcanzable? (70-85% típico para brushless)
  ✓ ¿T/W ratio es adecuado? (1.5-2.5 típico para multirotores)
```
...
**Workflow correcto**:
1. IA genera 10 opciones de motor/batería (rápido)
2. TÚ eliminas 7 por razones prácticas (disponibilidad en Paraguay)
3. IA calcula performance de las 3 restantes (acelera análisis)
