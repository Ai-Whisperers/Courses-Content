...
graph TD
    ...
    B --> B1[Exploratoria<br/>Familiarizarse con tema nuevo]
    B --> B2[Descriptiva<br/>Describir fenómeno]
    B --> B3[Correlacional<br/>Relaciones entre variables]
    B --> B4[Explicativa<br/>Causas y efectos]
    
    C --> C1[Experimental<br/>Manipula variables]
    C --> C2[Cuasi-experimental<br/>Sin asignación aleatoria]
    C --> C3[No experimental<br/>Observa sin intervenir]
    
    D --> D1[Cuantitativo<br/>Números y estadística]
    D --> D2[Cualitativo<br/>Narrativas y temas]
    D --> D3[Mixto<br/>Integra ambos]
...
flowchart TD
    ...
    B -->|Describir| C[Diseño Descriptivo<br/>Encuestas, observación]
    B -->|Explicar causas| D[Diseño Experimental<br/>Manipular variables]
    B -->|Explorar relaciones| E[Diseño Correlacional<br/>Asociaciones]
    
    C --> F[Definir Población<br/>y Muestra]
    D --> F
    E --> F
    
    F --> G[Operacionalizar<br/>Variables]
    G --> H[Seleccionar<br/>Instrumentos]
    H --> I[Plan de<br/>Análisis]
    I --> J[Consideraciones<br/>Éticas]
    J --> K[Protocolo<br/>Completo]
...
flowchart LR
    ...
    C --> D[Instrumentos<br/>Concretos]
    
    subgraph Ejemplo
        E[Comprensión<br/>Conceptual] --> F[Capacidad de explicar<br/>conceptos con palabras propias]
        F --> G[1. Respuestas a preguntas abiertas<br/>2. Mapas conceptuales<br/>3. Evaluaciones orales]
        G --> H[Rúbrica con 4 niveles:<br/>Superficial / Básico / Profundo / Experto]
    end
...
graph TD
    ...
    B --> B1[No hay efecto<br/>No hay relación]
    C --> C1[Direccional<br/>Mayor/Menor]
    C --> C2[No direccional<br/>Hay diferencia]
    
    subgraph Ejemplo_FPUNA
        D[H0: No hay diferencia en comprensión<br/>entre usuarios y no usuarios de IA]
        E[Ha direccional: Usuarios de IA tienen<br/>MENOR comprensión que no usuarios]
        F[Ha no direccional: HAY diferencia<br/>entre grupos sin especificar dirección]
    end
...
flowchart TD
    ...
    C --> D[Grupo Experimental<br/>n=30]
    C --> E[Grupo Control<br/>n=30]
    
    D --> F[Pre-test<br/>Comprensión inicial]
    E --> G[Pre-test<br/>Comprensión inicial]
    
    F --> H[INTERVENCIÓN<br/>Uso guiado de ChatGPT<br/>4 semanas]
    G --> I[CONTROL<br/>Métodos tradicionales<br/>4 semanas]
    
    H --> J[Post-test<br/>Comprensión final]
    I --> K[Post-test<br/>Comprensión final]
    
    J --> L[Comparación<br/>Estadística]
    K --> L
    
    L --> M[¿Hay diferencia<br/>significativa?]
...
sequenceDiagram
    ...
    Note over G1,G2: Sin asignación aleatoria<br/>Grupos intactos (secciones existentes)
    
    G1->>G1: Pre-test
    G2->>G2: Pre-test
    
    Note over G1: Intervención<br/>ChatGPT permitido
    Note over G2: Control<br/>Sin IA
    
    G1->>G1: Post-test
    G2->>G2: Post-test
    
    Note over G1,G2: Comparar diferencias<br/>+ covariables
```
...
graph TD
    ...
    C -->|Sí| D[Cuasi-experimental]
    C -->|No| E[No experimental]
    
    B --> F[Máxima validez<br/>interna]
    D --> G[Buena validez<br/>externa]
    E --> H[Explora relaciones<br/>sin causalidad]
...
mindmap
  root((Muestreo))
    Probabilístico
      Aleatorio Simple
        Cada individuo misma probabilidad
        Tabla de números aleatorios
      Estratificado
        Dividir en estratos homogéneos
        Muestreo aleatorio por estrato
      Por Conglomerados
        Seleccionar grupos completos
        Útil con poblaciones dispersas
      Sistemático
        Seleccionar cada k-ésimo elemento
    ...
    No Probabilístico
      Por Conveniencia
        ...
        Bajo costo rápido
      Por Cuotas
        Representar subgrupos
        Sin aleatorización
      Bola de Nieve
        Referidos por participantes
        Poblaciones ocultas
      Intencional/Propósito
        Casos ricos en información
...
flowchart LR
    ...
    subgraph Ejemplo
        G[d = 0.5 efecto medio<br/>α = 0.05<br/>Poder = 0.80] --> H[n ≈ 64 por grupo<br/>Total N = 128]
    end
...
graph TD
    ...
    B -->|Sí - Lista oficial| C[Muestreo Aleatorio<br/>Simple]
    B -->|No| D[Muestreo por<br/>Conveniencia]
    
    C --> E[Generar números<br/>aleatorios]
    E --> F[Contactar<br/>seleccionados]
    F --> G{¿Tasa respuesta<br/>>70%?}
    
    G -->|Sí| H[Muestra<br/>Representativa]
    G -->|No| I[Sesgo de<br/>No Respuesta]
    
    D --> J[Reclutar voluntarios<br/>secciones accesibles]
...
mindmap
  root((Validez))
    Interna
      ¿El tratamiento causó el efecto?
      Amenazas
        Historia
        Maduración
        Selección
      ...
      Cómo mejorar
        ...
        Pre-test equivalente
    Externa
      ¿Generalizable a otros contextos?
      Amenazas
        Muestra no representativa
        Contexto artificial
        Interacción tratamiento-selección
      Cómo mejorar
        Muestreo probabilístico
        Múltiples contextos
        Replicación
    De Constructo
      ¿Mides lo que crees medir?
      Amenazas
        Operacionalización inadecuada
      ...
      Cómo mejorar
        ...
        Triangulación
    Estadística
      ¿Conclusiones estadísticas correctas?
      Amenazas
...
flowchart TD
    ...
    B --> C[Alpha de Cronbach<br/>α]
    B --> D[Test-Retest<br/>r]
    B --> E[Inter-Rater<br/>Kappa κ]
    
    C --> F{α ≥ 0.70?}
    D --> G{r ≥ 0.70?}
    E --> H{κ ≥ 0.60?}
    
    F -->|Sí| I[Consistencia<br/>interna BUENA]
    F -->|No| J[Revisar ítems<br/>problemáticos]
    
    G -->|Sí| K[Estabilidad<br/>temporal BUENA]
    G -->|No| L[Ítems ambiguos<br/>o contexto cambia]
    
    H -->|Sí| M[Acuerdo entre<br/>evaluadores BUENO]
    H -->|No| N[Capacitar evaluadores<br/>o mejorar rúbrica]
...
graph LR
    ...
    B --> B1[Mitigación:<br/>Grupo control<br/>simultáneo]
    C --> C1[Mitigación:<br/>Asignación<br/>aleatoria]
    D --> D1[Mitigación:<br/>Estandarizar<br/>procedimientos]
...
flowchart TD
    ...
    A --> D[Riesgos y<br/>beneficios]
    A --> E[Confidencialidad]
    A --> F[Voluntariedad]
    A --> G[Contacto<br/>investigador]
    
    B --> H[Por qué se hace<br/>Objetivos claros]
    C --> I[Qué se pide<br/>Tiempo requerido]
    D --> J[Qué puede pasar<br/>Qué ganan]
    E --> K[Cómo se protegen<br/>datos personales]
    F --> L[Puede retirarse<br/>sin consecuencias]
    G --> M[A quién contactar<br/>con dudas/quejas]
...
sequenceDiagram
    ...
    I->>I: Diseñar protocolo completo
    I->>CE: Someter protocolo + formularios
    CE->>CE: Revisar riesgos/beneficios
    
    alt Aprobado
        CE->>I: Carta de aprobación
        I->>P: Reclutar participantes
        P->>I: Consentimiento firmado
        I->>I: Iniciar recolección datos
    else Observaciones
        CE->>I: Solicitar modificaciones
        I->>I: Revisar protocolo
        I->>CE: Re-someter
    end
    
    Note over I,P: No iniciar NUNCA sin aprobación ética
```
