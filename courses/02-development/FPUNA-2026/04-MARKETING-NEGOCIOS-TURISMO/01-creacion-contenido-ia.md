...
graph TD
    ...
    C --> D[Crear Prompts Estratégicos]
    D --> E[Generar Contenido con IA]
    E --> F{¿Cumple Objetivos?}
    F -->|No| G[Refinar Prompt]
    G --> E
    F -->|Sí| H[Edición Humana]
    H --> I[Optimización SEO]
    I --> J[Publicación y Monitoreo]
...
graph LR
    ...
    D --> E[Creación con IA]
    E --> F[Distribución Multicanal]
    F --> G[Análisis y Optimización]
    G --> A
...
graph TD
    ...
    B --> C[Brief SEO]
    C --> D[Generar Contenido con IA]
    D --> E[Optimización On-Page]
    E --> F[Meta Descriptions]
    E --> G[Headers H1-H3]
    E --> H[Internal Links]
    E --> I[Alt Text Imágenes]
    F --> J[Publicación]
    G --> J
    H --> J
    I --> J
    J --> K[Monitoreo Rankings]
...
flowchart TD
    ...
    C --> D[Batch de Contenido]
    D --> E{Control de Calidad}
    E -->|Revisar| F[Edición Humana]
    E -->|Aprobar| G[Banco de Contenido]
    F --> G
    G --> H[Programación Social Media]
    G --> I[Email Sequences]
    G --> J[Blog Posts]
...
graph TD
    ...
    A --> D[Email a Lista de Espera]
    A --> E[Thread Twitter Storytelling]
    A --> F[Artículo Blog SEO]
