...
**Question 10: B**
Specify the version in your prompt to get current syntax. "Use Playwright 1.40+ syntax."
...
**Question 17: B**
`mcr.microsoft.com/playwright:v1.40.0-jammy` is the official Playwright Docker image with browsers.
