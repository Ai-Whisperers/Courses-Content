...
## FPUNA Courses Repository Context

### Structure Understanding

This repository contains educational courses for Universidad Nacional de Asunción (Paraguay). Key directories:

- **`_compartido/`** (global library): Templates, presets, and tools ready for distribution
- **`cursos/02-desarrollo/FPUNA-2026/`**: The active summer course (2026)
- **`cursos/02-desarrollo/FPUNA-2026/COMPARTIDO/`**: Course-specific documentation

### Critical: Templates Are NOT Duplicates

The `.claude/` directories and configurations appearing in multiple locations within `_compartido/` are **intentional distribution points**, NOT redundancy:

```
_compartido/
├── 00-KITS-DE-INICIO-IA/KIT-CLAUDE-CODE/.claude/  ← Quick start path
└── 01-configuracion-herramientas/claude/.claude/   ← Deep dive path
```

**Pedagogical rationale**: Students have limited time and resources. The course's purpose is to provide ready-to-use tools, not to teach students how to build these tools from scratch. Identical content in multiple locations = multiple valid entry points to the same functional resource.

**NEVER flag these as "duplicates to consolidate"** - this would break the educational design.

### Track Structure (FPUNA-2026)

| Track | Content |
|-------|---------|
| 00-FUNDAMENTOS | Universal AI tools intro (Week 1) |
| 01-DESARROLLO-SOFTWARE | Architecture, patterns, testing |
| 02-ELECTRONICA | Circuits, PCB, firmware, IoT |
| 03-AERONAUTICA | CAD, aerodynamics, UAV design |
| 04-MARKETING | Digital marketing, hospitality |
| 05-INVESTIGACION | Academic research with AI |

Each track has: `modules/`, `starter-kit/`, `proyecto-final/`, and references `COMPARTIDO/`.